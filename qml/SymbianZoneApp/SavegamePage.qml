...
Page{
    ...
    Text {
      id: title
      color: "#ffffff"
      text: "Резервирование сохранений игр"
      font.pixelSize: 20
      font.bold: true
    ...
    Button {
      ...
      //anchors.verticalCenter: parent.verticalCenter
        ...
        iconSource: "image/SaveGames1.svg"
        onClicked: {application.launch("0xE132DCBA");}//0xE132DCB3
       }
    /*Button {
        y: 490
        //anchors.left: parent.left
